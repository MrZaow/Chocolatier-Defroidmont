...
<head>
    ...
    <meta name="description" content="Vétérinaire abyssin">
    <meta name="author" content="Webinpres">
    <title>Chocolatier Defroidmont</title>
...
<body>
    <header class="navbar navbar-inverse navbar-fixed-top wet-asphalt" role="banner">
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                ...
                <li><a href="#" style="pointer-events: none; cursor: default; "><strong> Téléphone : <i class="icon-phone"></i> 086/21.84.40</strong></a></li>
              </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <p>Images de nos réalisations artisanales récentes</p>
                    <div class="btn-group">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    ...
                    <p>Situé à l’entrée du stade de Bielmont, à 2 minutes en voiture du Palais de Justice et du grand hôpital (CHPLT), desservi par les bus 294, 295, 390, 393, 395, 705 et 708, le centre vétérinaire vous accueille du lundi matin au samedi après-midi. </p>
                </div><!--/.col-md-3-->

                <div class="col-md-3 col-sm-6">
                    <h4>Vétérinaire Abyssin</h4>
                    <div>
                        <ul class="arrow">
                ...
                <div class="col-md-3 col-sm-6">
                    <h4>Adresse</h4>
                    <address>
                        <p>Centre Vétérinaire Abyssin</p>
                        <p>Place d'Arles 4, 4800 Verviers, Belgique</p>
                        <p>087 23 00 23</p>
                    </address>
                </div> <!--/.col-md-3-->
            </div>
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                 Site réalisé par : <a target="_blank" href="http://webinpres.com/" title="Conception de sites web">Webinpres</a>.
                </div>
                <div class="col-sm-6">
                    <ul class="pull-right">
                        <li><a id="gototop" class="gototop" href="#"><i class="icon-chevron-up"></i> Haut de page</a></li><!--#gototop-->
                    </ul>
                </div>
            </div>
        </div>
